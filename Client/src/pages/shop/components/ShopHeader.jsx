...
export default function ShopHeader({
  ...
  const { getTotalItemsCount, restaurant } = useShop();
                ...
                <div className="flex-1 flex justify-end gap-3 pr-4">
                  <div className="relative">
                    <button
                      ...
                      className={`border-2 rounded-xl px-4 py-2 flex items-center gap-2 transition-colors ${isRestaurantActive
                      ...
                      <>
                        ...
                        <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-40 overflow-hidden">
                          <div className="py-2">
                            <button
                              onClick={() => {
                                const targetSlug = slug || restaurant?.slug;
                                if (targetSlug) {
                                  navigate(`/${targetSlug}/order/order-history`);
                                } else {
                  ...
                  <button
                    ...
                    disabled={!isRestaurantActive}
                    className={`relative rounded-xl px-4 py-2 flex items-center gap-2 shadow-md transition-colors ${isRestaurantActive
                  ...
                  <button
                    onClick={onCartClick}
                    disabled={!isRestaurantActive}
                    className={`rounded-xl px-4 py-2 flex items-center gap-3 shadow-md transition-colors ${isRestaurantActive
