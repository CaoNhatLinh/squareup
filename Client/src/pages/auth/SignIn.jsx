...
export default function SignIn() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      console.log('User from Google popup:', user);
      ...
      try {
        ...
        if (!existing) {
          await upsertRestaurant(user.uid, {
            ownerUid: user.uid,
        ...
        console.warn('fetchRestaurant/upsertRestaurant check failed', e);
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col">      <nav className="bg-white shadow-sm">
        ...
        <div className="max-w-md w-full">          <div className="bg-white rounded-lg shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 px-4 py-3 rounded-lg font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
            >
            ...
            </button>            <div className="relative mb-6">
