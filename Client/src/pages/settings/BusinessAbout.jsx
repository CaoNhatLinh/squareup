...
<path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" fill="#000000"/>
  ...
  const handleImageUpload = async (imageType, base64Data = null) => {
    ...
    try {
      ...
      setMessage(
        `Failed to upload ${imageType}: ${error.message || "Unknown error"}`
      );
    } finally {
      setProcessingImages((prev) => ({ ...prev, [imageType]: false }));
    }
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-full lg:max-w-6xl mx-auto">
            ...
            <div className="group">
              ...
              <p className="text-xs text-gray-500 mt-1 ml-10">
                This description will be displayed on your public shop page
              </p>
            </div>
                ...
                {(socialMedia || []).length === 0 && (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-sm mt-1">
                      Click "Add Social Media" to get started.
                    </p>
                  </div>
                )}
              </div>
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex gap-3">
                      <input
                        ...
                        onChange={(e) =>
                          e.target.files[0] &&
                          handleImageSelect(e.target.files[0], "logo")
                        }
                        className="hidden"
                      />
                      <button
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-blue-700 mt-1">
                            Square image, minimum 200×200px. PNG or JPG format.
                            Will be automatically resized for optimal
                            performance.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex gap-3">
                      <input
                        ...
                        onChange={(e) =>
                          e.target.files[0] &&
                          handleImageSelect(e.target.files[0], "cover")
                        }
                        className="hidden"
                      />
                      <button
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-purple-700 mt-1">
                            Landscape image, minimum 1200×400px. Will be
                            displayed as header on your shop page and
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex gap-3">
                      <input
                        ...
                        onChange={(e) =>
                          e.target.files[0] &&
                          handleImageSelect(e.target.files[0], "featured")
                        }
                        className="hidden"
                      />
                      <button
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-emerald-700 mt-1">
                            Showcase your best dishes or restaurant interior.
                            Will be featured prominently on your shop page and
                            automatically resized to 800×600px for optimal
                            performance.
                          </p>
                        </div>
                      </div>
