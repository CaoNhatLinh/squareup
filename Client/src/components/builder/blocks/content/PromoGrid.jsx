...
export default function PromoGridBlock({
  ...
  const displayPromos = globalUseRealData ? promos : (promotions && promotions.length > 0 ? promotions : defaultPromos);
  ...
  if (globalUseRealData && displayPromos.length === 0 && isPublic) {
    return null;
  }
                ...
                <div className="text-center mb-12">
                  {showDecorativeElements && (
                    <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
                      <HiSparkles className="w-6 h-6 animate-spin" style={{ animationDuration: '3s', color: resolvedText }} />
                      <span className="font-bold text-lg" style={{ color: resolvedText }}>🔥 Special Offers</span>
                    </div>
                  )}
                  <StyledText
                    tag="h2"
                  ...
                  >
                    {title || "Don't Miss Out on Amazing Deals!"}
                  </StyledText>
                  <StyledText
                    tag="p"
                    ...
                    data-block-id={blockId}
                  >
                    {subtitle || "Limited time promotions and exclusive discounts just for you. Save big on your favorite items!"}
                  </StyledText>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="relative mb-8">
                ...
                <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                  ...
                  <div className={`grid gap-6 mb-8 ${isMobile ? 'grid-cols-1' :
        ...
        return (
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              <div className={`grid gap-8 ${isMobile ? 'grid-cols-1' :
                isTablet ? 'grid-cols-2' :
                  'grid-cols-3'
                }`}>
                  ...
                  >
                    <div className="relative p-8 flex-1 flex flex-col">
                      ...
                      <div className="relative flex-1 flex flex-col">
                        ...
                        {showCode && (promo.code || promo.promoCode) && (
                          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200 mt-auto">
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                onClick={() => handleCopyCode(promo.code || promo.promoCode)}
                                className="text-gray-400 hover:text-gray-600 transition-colors"
                              >
                                {copiedCode === (promo.code || promo.promoCode) ? <span className="text-green-500 text-xs">Copied</span> : <HiTag className="w-5 h-5" />}
                              </button>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100">
                          <button
                            onClick={() => handleCopyCode(promo.code || promo.promoCode)}
                            className="w-full bg-gradient-to-r from-gray-900 to-gray-800 text-white font-semibold py-3 px-6 rounded-xl hover:from-gray-800 hover:to-gray-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                          >
                            {copiedCode === (promo.code || promo.promoCode) ? 'Code Copied!' : 'Claim Offer'}
                          </button>
                        </div>
                      </div>
                    </div>
              ...
              `}>
                {displayPromos.map((promo, index) => (
                  <div
                    key={promo.id}
                    className={`
                      ${currentLayout === 'slider' ? 'min-w-[320px] snap-start' : 'w-[calc(33.33%-1.5rem)] min-w-[280px]'}
  ...
  return (
    <>
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-4 rounded-lg">
                    ...
                    {showCode && (promo.code || promo.promoCode) && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                          ...
                          >
                            {copiedCode === (promo.code || promo.promoCode) ? <span className="text-green-500 text-xs">Copied</span> : <HiTag className="w-4 h-4" />}
                          </button>
                        </div>
                      </div>
                    )}
