...
const Input = forwardRef(({
  ...
  return (
    <div className={`${fullWidth ? 'w-full' : ''} ${isHorizontal ? 'flex items-start gap-4' : ''} ${containerClassName}`}>
      {label && (
        <label className={`block text-sm font-medium text-gray-700 ${isHorizontal ? 'w-1/3 pt-2' : 'mb-1'}`}>
          {label}
